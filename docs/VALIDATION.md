...
## 2026-09-03 PS2 ELF-backed memory-map host validation
...
Fresh clean Release results:

- GCC 14.2: 6/6 tests passed;
- Clang 17: 6/6 tests passed.

Windows/MSVC validation of `ps2_memory_map_tests` is pending on the feature branch.
