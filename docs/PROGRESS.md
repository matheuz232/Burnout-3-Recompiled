...
| R5900 IR v0 | CI_VALIDATED | Provenance-carrying non-executable IR lowers NOP, ADDU, ADDIU and ORI with explicit operand semantics; unsupported instructions return `UnsupportedInstruction` and emit no partial IR; Windows/MSVC suite passes 24/24 |
